...
namespace Entity
{
    public class Campaign
    {
        ...
        public Campaign(int id, string subject, string body, List<Email> emailList, DateTime date, FileAttach fileAttacher) : this(id, subject, body, emailList, date)
        {
        ...
        public FileAttach FileAttacher { get => fileAttacher; set => fileAttacher = value; }
        /// <summary>
