...
namespace CampaignFileAttacher
{
    public class FileAttacher
    {
        ...
        public FileAttacher(string nameFile, string filePath)
        {
            this.campaignId = -1;
            this.nameFile = nameFile;
            this.filePath = filePath;
        }
        public FileAttacher(int campaignId, string nameFile, string filePath) :this(nameFile, filePath)
        {
        ...
        public static bool ValidateSize(string path)
        {
